...
CHANGE COLUMN `num` `num` BIGINT(13) NULL DEFAULT '0' COMMENT '订单计数' ;
ALTER TABLE `app_dian`
CHANGE COLUMN `num` `num` BIGINT(14) NOT NULL DEFAULT '0' COMMENT '开点编号' ;

CREATE TABLE `app_qq_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
